  ...
  return (
    <Box py={{ xs: 3, md: 6 }}>
      <CenteredContent>
        <Stack spacing={3}>
          <ContentBox>
            <Typography variant="h1">Polityka prywatności Voltiq</Typography>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={9}>
              <Stack spacing={3}>
                <ContentBox isSection title="1. Administrator danych">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <ContentBox isSection title="2. Zakres gromadzonych danych">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <ContentBox isSection title="3. Cel przetwarzania danych">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <ContentBox isSection title="4. Udostępnianie danych">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Pellentesque habitant morbi tristique senectus et netus et
                ...
                <ContentBox isSection title="5. Bezpieczeństwo danych">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <ContentBox isSection title="6. Pliki cookies">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <ContentBox isSection title="7. Prawa użytkownika">
                  <Typography>
                ...
                <ContentBox isSection title="8. Zmiany polityki prywatności">
                  <Typography>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
